...
and is known to work well for ELF files used by linux and MACH-O files used by macos. The docu seems to suggest that it
works for the PE/COFF files used on windows but I haven't tested this.
